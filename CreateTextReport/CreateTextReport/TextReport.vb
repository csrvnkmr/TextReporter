...
Public Class TextReport
    Public Property ReportHeader As New TextReportSectionCollection
    Public Property ReportFooter As New TextReportSectionCollection
    Public Property PageHeader As New TextReportSectionCollection
    Public Property PageFooter As New TextReportSectionCollection
    Public Property Groups As New TextReportGroupCollection
    Public Property DetailSection As New TextReportSectionCollection
    Public Property PageSize As Integer = 80
    Public Property ReportSummaryFields As New SummaryFieldCollection
    Public Property PageSummaryFields As New SummaryFieldCollection
    Public Property FormulaFields As New FormulaFieldCollection
            ...
            If i > 0 Then
                ...
                If mChangingGroupIndex <> -1 Then
                    ...
                    For grpcounter As Integer = mGroupCount - 1 To mChangingGroupIndex Step -1
                        Dim mGrp As TextReportGroup = Groups(grpcounter)
