Public Delegate Function dlgGetSubreportDT(pParentReport As TextReportV3, pSubReport As TextReportV3, pDataRow As DataRow) As DataTable
Public Class TextReportSectionV3
    Public ReadOnly Property Fields As New Dictionary(Of Integer, List(Of TextReportFieldV3))
    Public ReadOnly Property Subreports As New Dictionary(Of Integer, List(Of SubReportV3))
    Public Sub AddFields(pLineNumber As Integer, pFields As IEnumerable(Of TextReportFieldV3))
        If Not Fields.ContainsKey(pLineNumber) Then
            Fields.Add(pLineNumber, New List(Of TextReportFieldV3))
        End If
        ...
        For Each mKey As Integer In Fields.Keys
            For Each mField In Fields(mKey)
                ...
                If mField.FieldType = enumFieldType.DataField Then
                    Dim mDBField As DBFieldV3 = mField
                    mDBField.DR = pDR
                End If
